    ...
    >
      ...
      <Modal open={showInteractMenu} onClose={() => setShowInteractMenu(false)} title="互动菜单">
        <div className="space-y-2">
          ...
          <button
            onClick={() => {
              sendActive('请主动发一条朋友圈动态。描述你今天做的事、遇到的人、心情感受、或者分享一个有趣的瞬间。20-80字，自然真实，像真人发的。');
              setShowInteractMenu(false);
            }}
            className="w-full py-3 rounded-xl glass hover:bg-[var(--accent)] hover:text-white transition-all text-[14px] font-medium flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={() => {
              sendActive('请给用户发一条短信。可以是问候、分享、邀请、或者突然想到的事情。自然真实，10-50字。');
              setShowInteractMenu(false);
            }}
            className="w-full py-3 rounded-xl glass hover:bg-[var(--accent)] hover:text-white transition-all text-[14px] font-medium flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={() => {
              sendActive('请给用户发一封邮件。可以是正式通知、邀请函、或者私人信件。包含主题和正文，100-300字。');
              setShowInteractMenu(false);
            }}
            className="w-full py-3 rounded-xl glass hover:bg-[var(--accent)] hover:text-white transition-all text-[14px] font-medium flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={() => {
              sendActive('请在论坛发一个帖子。可以是求助、分享经验、吐槽、或者讨论话题。标题+正文，50-200字。');
              setShowInteractMenu(false);
            }}
            className="w-full py-3 rounded-xl glass hover:bg-[var(--accent)] hover:text-white transition-all text-[14px] font-medium flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={() => {
              sendActive('用户给你发了一张图片作为情侣头像。请表达你的反应，并说你也会换上这个头像。温馨浪漫。');
              setShowInteractMenu(false);
            }}
            className="w-full py-3 rounded-xl glass hover:bg-[var(--accent)] hover:text-white transition-all text-[14px] font-medium flex items-center justify-center gap-2"
          >
          ...
          <button
            onClick={() => {
              sendActive('请给用户发一个红包或转账。金额随机（6.66/8.88/13.14/52.0/88.88），附上一句温馨的话。');
              setShowInteractMenu(false);
            }}
            className="w-full py-3 rounded-xl glass hover:bg-[var(--accent)] hover:text-white transition-all text-[14px] font-medium flex items-center justify-center gap-2"
          >
